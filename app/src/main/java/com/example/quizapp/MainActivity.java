...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view){
        ansA.setBackgroundColor(Color.rgb(5,211,192));
        ansB.setBackgroundColor(Color.rgb(5,211,192));
        ansC.setBackgroundColor(Color.rgb(5,211,192));
        ansD.setBackgroundColor(Color.rgb(5,211,192));
